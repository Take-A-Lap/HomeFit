...
module.exports = {
  ...
  addNewUser: (weight, numPushUps, jogDist, age, sex, height, squatComf, goals, email, dob, preferredUsername) => db.any(`
    INSERT INTO users 
    (weight, num_push_ups, jog_dist, age, sex, height, squat_comf, all_sets, workout_completes, goals, user_email, birthdate, preferred_username)
    VALUES
    ($1, $2, $3, $4, $5, $6, $7, $8, 0, 0, $9, $10, $11)
  `, [weight, numPushUps, jogDist, age, sex, height, squatComf, goals, email, dob, preferredUsername]),
