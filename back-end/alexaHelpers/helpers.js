...
module.exports = {
  invocationIntent: (name) => {
    ...
    if (name === "not linked yet" || name === undefined){
      ...
      greetingSpeech = "Welcome back to Home Fit Trainer " + name + ". When you are ready to begin your workout just let me know, or if you rather check out what I recommend you eat for the day you can ask me that as well. So what would you like to do?"
    }
