  ...
  .then(user => {
    if (user !== undefined) {
      if (current !== undefined){
        ...
        cadence += ` <s> Lets take a break.</s> <s> Let me know when you areready to do another set </s> <s> Or if you want to start the next exercise, we can do that as well</s> </speak>`;
        conv.ask(new SimpleResponse({
