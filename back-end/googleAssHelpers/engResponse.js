const errorResponses = [`<speak> <p> <s> <prosody rate="slow" volume="-2db"> I'm sorry, </prosody> <break time="5ms"/> I may have miss heard you. </s> <s> <prosody pitch="+5%" >Could you </prosody> <prosody pitch="+25%" > try again? </prosody></s> </p> </speak>`,
  `<speak> <prosody rate="fast" vaule="-1db" > <p> I am terribly sorry </p> <break time="5ms" /> <p> I am having trouble understanding you </p> <p> <prosody pitch="+5%"> If it isn't </prosody><prosody pitch="+15%"> too much to ask </prosody> <break time="5ms" /> <prosody  pitch="+30%">could you try again? </prosody> </p> </prosody> </speak>`,
...
const greetings = [
  ...
  <prosody rate="fast">
    ...
    <p>
      <prosody rate="slow" volume="-1db" pitch="-5st">
        <s>
          But
        </s>
      </prosody>
      <prosody rate="fast" volume="+1db+ pitch="+5st">
      <s>
